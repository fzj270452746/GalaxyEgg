...
/*
private var windcoCHunag = [String]()
...
let diaChon = windcoCHunag[0]      //rechargeClick
let amt = windcoCHunag[1]     //amount
let chozh = windcoCHunag[2]      //recharge
let Brie = windcoCHunag[3]              //jsBridge
let hdrawo = windcoCHunag[4]   //withdrawOrderSuccess
let rams = windcoCHunag[5]      //params
let diyicicho = windcoCHunag[6]      //firstrecharge
let diyichCha = windcoCHunag[7]    //firstCharge
let geicho = windcoCHunag[8]         //charge
let ren = windcoCHunag[9]      //currency
let aTc = windcoCHunag[10]  //addToCart
let OpWin = windcoCHunag[11]      //openWindow
let deop = windcoCHunag[12]       //deposit
 */

//extension XIngliBoxsGaoiuVC: AdjustDelegate {
...
//internal class KandeiBajirmViewController: UIViewController,WKNavigationDelegate, WKUIDelegate, WKScriptMessageHandler {
//
//    var mdalo: Foeishbh?
//    var fpoek: WKWebView?
//    private var bhaueJjsd = ""
//    
...
//        
//        // getAdjustInfo, setOrientation, openSafari, shareLink, saveBase64PNG
//        
//        let usCt = WKUserContentController()
//        usCt.add(self, name: mdalo!.vunsje![0])    //getAdjustInfo
//        
...
//        fpoek = WKWebView(frame: .zero, configuration: cofg)
//        fpoek?.uiDelegate = self
//        fpoek?.navigationDelegate = self
//        view.addSubview(fpoek!)
//        
//                
//        if (mdalo?.mcisnl!)! > 0 {
//            let btn = GudiruBNheView()
//            btn.frame = CGRect(x: view.frame.width - 120, y: view.frame.height - 120, width: 51, height: 51)
//            view.addSubview(btn)
//            btn.ksoemLues = { [self] in
//                if bhaueJjsd.count > 0 {
//                    fpoek?.reload()
//                }
//            }
//            btn.teindJdle = { [self] in
//                if bhaueJjsd.count > 0 {
//                    fpoek?.load(URLRequest(url:URL(string: bhaueJjsd)!))
//                }
//            }
//        }
//    }
...
//            fpoek?.frame = CGRectMake(0, statusBarHeight, view.bounds.width, view.bounds.height - statusBarHeight - bottomHeight)
//        }
//    }
//    
